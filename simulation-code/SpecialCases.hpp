...
// Simulations of neuromodulation and assembly outgrowth in TODO Lehr, Luboeinski, Tetzlaff, 2021
//#define MEMORY_OUTGROWTH_P3
#ifdef MEMORY_OUTGROWTH_P3
	#define MEMORY_CONSOLIDATION_P1
	// in script, rename connections.txt to connections_P1.txt or connections.txt.bak
	#define CORE_SIZE_CMD 150
	#warning "Special case: MEMORY_OUTGROWTH_P3"
#endif
